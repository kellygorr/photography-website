...
const img1 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/summer5.png'
const img2 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/summer8.png'
const img3 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/summer1.png'
const img4 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/summer6.png'
const img5 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/summer3.png'
const img6 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/summer4.png'
const img7 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/summer7.png'
const img8 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/summer14.png'
const img9 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/summer11.png'
const img10 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/summer15.png'
const img11 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/summer12.png'

const img12 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/itv6.jpg'
const img13 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/itv3.jpg'
const img14 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/itv4.jpg'
const img15 = process.env.REACT_APP_IMAGE_URL + 'assets/images/interactive-video-playlist/itv5.jpg'
